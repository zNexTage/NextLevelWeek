                            ...
                            scheduleItems.map((scheduleItem, index) => {
                                return (
                                    <div key={scheduleItem.week_day} className="schedule-item">
                                        ...
                                        <Input name="from" value={scheduleItem.from} label="Das" type="time" onChange={(e) => setScheduleItemsValue(index, "from", e.target.value)} />
                                        <Input name="to" value={scheduleItem.to} label="Até" type="time" onChange={(e) => setScheduleItemsValue(index, "to", e.target.value)} />
                                    </div>
                                )
                            })
                        }
